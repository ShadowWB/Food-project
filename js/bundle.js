...
function cards() {
  (0,_services_services__WEBPACK_IMPORTED_MODULE_0__.getResource)("http://localhost:3000/menu").then(cardsArr => {
    cardRendering(cardsArr, ".menu .container");
  });
  function cardRendering(arrData, parentClass) {
    arrData.forEach(_ref => {
      let {
        img,
        altimg,
        title,
...
function forms(formSelector, modalTimerId) {
  ...
  function postDataBind(form) {
    form.addEventListener("submit", event => {
      ...
      (0,_services_services__WEBPACK_IMPORTED_MODULE_1__.postData)("http://localhost:3000/requests", jsonFormData).then(response => {
...
/* harmony import */ var _functions__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./functions */ "./js/modules/functions.js");
...
function slider(_ref) {
  ...
  totalCountSlides.textContent = (0,_functions__WEBPACK_IMPORTED_MODULE_1__.getZero)(slides.length);
  currentCounterSlide.textContent = (0,_functions__WEBPACK_IMPORTED_MODULE_1__.getZero)(slideIndex);
...
function timer(timerSelector, deadLine) {
  ...
  function setClock(selector, endTime) {
    ...
    function updateClock() {
      ...
      days.innerHTML = (0,_functions__WEBPACK_IMPORTED_MODULE_0__.getZero)(allData.days);
      hours.innerHTML = (0,_functions__WEBPACK_IMPORTED_MODULE_0__.getZero)(allData.hours);
      minutes.innerHTML = (0,_functions__WEBPACK_IMPORTED_MODULE_0__.getZero)(allData.minutes);
      seconds.innerHTML = (0,_functions__WEBPACK_IMPORTED_MODULE_0__.getZero)(allData.seconds);
...
window.addEventListener("DOMContentLoaded", () => {
  const modalTimerId = setTimeout(() => (0,_modules_modal__WEBPACK_IMPORTED_MODULE_6__.openModal)('.modal', modalTimerId), 5000);
  (0,_modules_tabs__WEBPACK_IMPORTED_MODULE_0__["default"])('.tabheader__item', '.tabcontent', '.tabheader__items', 'tabheader__item_active');
  (0,_modules_timer__WEBPACK_IMPORTED_MODULE_1__["default"])('.timer', '2023-6-1');
  (0,_modules_cards__WEBPACK_IMPORTED_MODULE_2__["default"])();
  (0,_modules_forms__WEBPACK_IMPORTED_MODULE_4__["default"])("form", modalTimerId);
  (0,_modules_calculator__WEBPACK_IMPORTED_MODULE_3__["default"])();
  (0,_modules_modal__WEBPACK_IMPORTED_MODULE_6__["default"])(".modal", "[data-modal]", modalTimerId);
